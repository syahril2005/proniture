                ...
                <form action="{{ route('dashboard.product.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap mx-3 mb-6">
                        ...
                        <div class="w-full px-3 mb-6 md:w-1/2 lg:w-1/3">
                            ...
                            <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="description" type="text" name="description">{!! old('description') ??  $item->description !!}</textarea>
                        ...
                        <div class="w-full px-3 mb-6 md:w-1/2 lg:w-1/3">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="price" type="number" name="price" value="{{ old('price') ?? $item->price }}">
